  ...
  code = {
    ...
    testthat::expect_no_error(
      object = redispatching_cross_border(
        eic_in = "10YDE-VE-------2",
        eic_out = "10YDE-EON------1",
        period_start = lubridate::ymd(x = "2024-03-01", tz = "CET"),
        period_end = lubridate::ymd(x = "2024-03-11", tz = "CET"),
        tidy_output = TRUE
      )
    )
    testthat::expect_no_error(
  ...
  code = {
    ...
    testthat::expect_no_error(
      object = countertrading(
        ...
        eic_out = "10YES-REE------0",
        period_start = lubridate::ymd(x = "2020-02-01", tz = "CET"),
        period_end = lubridate::ymd(x = "2020-02-15", tz = "CET"),
        tidy_output = TRUE
      )
    )
  }
  ...
  code = {
    ...
    testthat::expect_error(
      object = intraday_cross_border_transfer_limits(
        ...
        eic_out = "11Y0-0000-0265-K",
        period_start = lubridate::ymd(x = "2023-08-16", tz = "CET"),
        period_end = lubridate::ymd(x = "2024-08-17", tz = "CET"),
        tidy_output = FALSE,
        security_token = .test_token
      ),
      regexp = "1 year range limit should be applied"
