...
Covers imbalance netting (3.10), aFRR exchange (3.16), and mFRR exchange
(3.17) per border between an acquiring and a connecting domain.
...
- process_type:
  ...
  type of balancing process "A51" aFRR "A60" mFRR with scheduled
  activation "A61" mFRR with direct activation "A63" Imbalance Netting
