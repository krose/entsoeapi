...
``` r
head(entsoeapi::market_product_types)
#> # A tibble: 6 × 3
#>   code  title                                                   description                                             
#>   <chr> <chr>                                                   <chr>                                                   
#> 1 A01   Standard balancing product                              A harmonised balancing product defined by all TSOs for …
#> 2 A02   Specific balancing product                              A product different from a standard product.            
#> 3 A03   Product from integrated scheduling process              From the EBGL Article 2 (19), means an iterative proces…
#> 4 A04   Local balancing product                                 A balancing product that is neither standard nor specif…
#> 5 A05   Standard mFRR product eligible for scheduled activation Standard mFRR product eligible for scheduled activation.
#> 6 A06   Standard mFRR product eligible for direct activation    Standard mFRR product eligible for direct activation.   
```
