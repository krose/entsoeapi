...
``` r
head(entsoeapi::connection_category_types)
#> # A tibble: 6 × 3
#>   code  title                           description                                              
#>   <chr> <chr>                           <chr>                                                    
#> 1 E03   Maximum voltage                 A maximum voltage connection category.                   
#> 2 E04   High voltage                    A high voltage connection category.                      
#> 3 E05   Medium voltage                  A medium voltage connection category.                    
#> 4 E06   Low voltage                     A low voltage connection category.                       
#> 5 E07   High voltage / transformation   A high voltage connection category with transformation.  
#> 6 E08   Medium voltage / transformation A  medium voltage connection category with transformation
```
