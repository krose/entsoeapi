...
``` r
head(entsoeapi::currency_types)
#> # A tibble: 6 × 3
#>   code  title                       description                                
#>   <chr> <chr>                       <chr>                                      
#> 1 BAM   "Bosnian convertible marka" The Legal tender of Bosnia and Herzegovina.
#> 2 BGN   "Bulgarian lev"             The Legal tender of Bulgaria.              
#> 3 CHF   "Swiss Franc"               The Legal tender of Switzerland.           
#> 4 CZK   "Czech Koruna"              The legal tender of the Czech Republic.    
#> 5 DKK   "Danish Kroner "            The Legal tender of Denmark.               
#> 6 EUR   "EURO"                      The European legal tender.                 
```
