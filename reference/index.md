...
- [`allocated_transfer_capacities_3rd_countries()`](https://krose.github.io/entsoeapi/reference/allocated_transfer_capacities_3rd_countries.md)
  : Get Transfer Capacities Allocated with Third Countries — Explicit
  (12.1.H)
...
- [`gen_storage_mean_filling_rate()`](https://krose.github.io/entsoeapi/reference/gen_storage_mean_filling_rate.md)
  : Get Weekly Average Filling Rate of Water Reservoirs and Hydro
...
- [`outages_both()`](https://krose.github.io/entsoeapi/reference/outages_both.md)
  : Get Unavailability of Production & Generation Units (15.1.A&B +
  15.1.C&D)
...
- [`transmission_pair_eic_dict`](https://krose.github.io/entsoeapi/reference/transmission_pair_eic_dict.md)
