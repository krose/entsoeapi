...
#> <- HTTP/2 400 
#> <- date: Thu, 12 Mar 2026 10:23:15 GMT
...
#> ✔ /tmp/RtmpqMxwAp/001-PROCURED_BALANCING_CAPACITY_R3_202312312300-202401012300.xml has been read in
#> 
#> ── API call ────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
#> <- 
#> ✔ response has arrived
#> ✔ /tmp/RtmpqMxwAp/001-PROCURED_BALANCING_CAPACITY_R3_202401010500-202401011800.xml has been read in
#> 
#> ── API call ────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
#> <- HTTP/2 200 
#> <- date: Thu, 12 Mar 2026 10:23:16 GMT
#> <- content-type: application/zip
#> <- content-length: 2492
#> <- content-disposition: attachment; filename="Procured Balancing Capacity_202312312300-202401012300.zip"
#> <- x-content-type-options: nosniff
...
#> <- 
#> ✔ response has arrived
#> ✔ /tmp/RtmpqMxwAp/001-PROCURED_BALANCING_CAPACITY_R3_202401011400-202401011800.xml has been read in
#> 
#> ── API call ────────────────────────────────────────────────────────────────────────────────────────────────────────────
...
#> <- 
#> ✔ response has arrived
#> ✔ /tmp/RtmpqMxwAp/001-PROCURED_BALANCING_CAPACITY_R3_202401011600-202401012300.xml has been read in
...
#> $ created_date_time             <dttm> 2026-03-12 10:23:15, 2026-03-12 10:23:15, 2026-03-12 10:23:15, 2026-03-12 10:23…
