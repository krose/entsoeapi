...
``` r
head(entsoeapi::settlement_method_types)
#> # A tibble: 2 × 3
#>   code  title        description                                                                       
#>   <chr> <chr>        <chr>                                                                             
#> 1 E01   Profiled     The settlement method regards profiled metered accounting points.                 
#> 2 E02   Non-profiled The settlement method regards continuous metered (non-profiled) accounting points.
```
