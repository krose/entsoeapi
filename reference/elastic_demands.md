...
#> <- HTTP/2 400 
#> <- date: Wed, 04 Mar 2026 22:08:11 GMT
...
#> <- HTTP/2 200 
#> <- date: Wed, 04 Mar 2026 22:08:12 GMT
#> <- content-type: text/xml
...
#> <- HTTP/2 200 
#> <- date: Wed, 04 Mar 2026 22:08:13 GMT
#> <- content-type: text/xml
...
#> <- HTTP/2 200 
#> <- date: Wed, 04 Mar 2026 22:08:14 GMT
#> <- content-type: text/xml
...
#> processing xml list ■■■■■■■■■■■                       33% | ETA:  3s
#> ℹ No additional definitions added!
#> processing xml list ■■■■■■■■■■■                       33% | ETA:  3s
#> processing xml list ■■■■■■■■■■■■■■■■                  50% | ETA:  3s
#> ℹ No additional definitions added!
#> processing xml list ■■■■■■■■■■■■■■■■                  50% | ETA:  3s
#> ℹ No additional definitions added!
#> processing xml list ■■■■■■■■■■■■■■■■                  50% | ETA:  3s
...
#>  $ created_date_time                              : POSIXct[1:585], format: "2026-03-04 22:08:12" "2026-03-04 22:08:12" ...
